...
! =======================
   ...
   integer(IntKi), public, parameter :: ADI_x_AD_rotors_DMST_UA_element_x =   5 ! ADI%AD%rotors(DL%i1)%DMST%UA%element(DL%i2, DL%i3)%x
   integer(IntKi), public, parameter :: ADI_x_AD_rotors_AA_DummyContState =   6 ! ADI%AD%rotors(DL%i1)%AA%DummyContState
   integer(IntKi), public, parameter :: ADI_x_AD_FVW_W_Gamma_NW          =   7 ! ADI%AD%FVW%W(DL%i1)%Gamma_NW
   integer(IntKi), public, parameter :: ADI_x_AD_FVW_W_Gamma_FW          =   8 ! ADI%AD%FVW%W(DL%i1)%Gamma_FW
   integer(IntKi), public, parameter :: ADI_x_AD_FVW_W_Eps_NW            =   9 ! ADI%AD%FVW%W(DL%i1)%Eps_NW
   integer(IntKi), public, parameter :: ADI_x_AD_FVW_W_Eps_FW            =  10 ! ADI%AD%FVW%W(DL%i1)%Eps_FW
   integer(IntKi), public, parameter :: ADI_x_AD_FVW_W_r_NW              =  11 ! ADI%AD%FVW%W(DL%i1)%r_NW
   integer(IntKi), public, parameter :: ADI_x_AD_FVW_W_r_FW              =  12 ! ADI%AD%FVW%W(DL%i1)%r_FW
   integer(IntKi), public, parameter :: ADI_x_AD_FVW_UA_element_x        =  13 ! ADI%AD%FVW%UA(DL%i1)%element(DL%i2, DL%i3)%x
   integer(IntKi), public, parameter :: ADI_z_AD_rotors_BEMT_phi         =  14 ! ADI%AD%rotors(DL%i1)%BEMT%phi
   integer(IntKi), public, parameter :: ADI_z_AD_rotors_AA_DummyConstrState =  15 ! ADI%AD%rotors(DL%i1)%AA%DummyConstrState
   integer(IntKi), public, parameter :: ADI_z_AD_FVW_W_Gamma_LL          =  16 ! ADI%AD%FVW%W(DL%i1)%Gamma_LL
   integer(IntKi), public, parameter :: ADI_z_AD_FVW_residual            =  17 ! ADI%AD%FVW%residual
   integer(IntKi), public, parameter :: ADI_u_AD_rotors_NacelleMotion    =  18 ! ADI%AD%rotors(DL%i1)%NacelleMotion
   integer(IntKi), public, parameter :: ADI_u_AD_rotors_TowerMotion      =  19 ! ADI%AD%rotors(DL%i1)%TowerMotion
   integer(IntKi), public, parameter :: ADI_u_AD_rotors_HubMotion        =  20 ! ADI%AD%rotors(DL%i1)%HubMotion
   integer(IntKi), public, parameter :: ADI_u_AD_rotors_BladeRootMotion  =  21 ! ADI%AD%rotors(DL%i1)%BladeRootMotion(DL%i2)
   integer(IntKi), public, parameter :: ADI_u_AD_rotors_BladeMotion      =  22 ! ADI%AD%rotors(DL%i1)%BladeMotion(DL%i2)
   integer(IntKi), public, parameter :: ADI_u_AD_rotors_TFinMotion       =  23 ! ADI%AD%rotors(DL%i1)%TFinMotion
   integer(IntKi), public, parameter :: ADI_u_AD_rotors_UserProp         =  24 ! ADI%AD%rotors(DL%i1)%UserProp
   integer(IntKi), public, parameter :: ADI_y_AD_rotors_NacelleLoad      =  25 ! ADI%AD%rotors(DL%i1)%NacelleLoad
   integer(IntKi), public, parameter :: ADI_y_AD_rotors_HubLoad          =  26 ! ADI%AD%rotors(DL%i1)%HubLoad
   integer(IntKi), public, parameter :: ADI_y_AD_rotors_TowerLoad        =  27 ! ADI%AD%rotors(DL%i1)%TowerLoad
   integer(IntKi), public, parameter :: ADI_y_AD_rotors_BladeLoad        =  28 ! ADI%AD%rotors(DL%i1)%BladeLoad(DL%i2)
   integer(IntKi), public, parameter :: ADI_y_AD_rotors_TFinLoad         =  29 ! ADI%AD%rotors(DL%i1)%TFinLoad
   integer(IntKi), public, parameter :: ADI_y_AD_rotors_WriteOutput      =  30 ! ADI%AD%rotors(DL%i1)%WriteOutput
   integer(IntKi), public, parameter :: ADI_y_HHVel                      =  31 ! ADI%HHVel
   integer(IntKi), public, parameter :: ADI_y_PLExp                      =  32 ! ADI%PLExp
   integer(IntKi), public, parameter :: ADI_y_IW_WriteOutput             =  33 ! ADI%IW_WriteOutput
   integer(IntKi), public, parameter :: ADI_y_WriteOutput                =  34 ! ADI%WriteOutput
...
subroutine ADI_VarPackContState(V, x, ValAry)
   ...
   associate (DL => V%DL, VarVals => ValAry(V%iLoc(1):V%iLoc(2)))
      ...
      case (ADI_x_AD_rotors_DMST_UA_element_x)
         VarVals = x%AD%rotors(DL%i1)%DMST%UA%element(DL%i2, DL%i3)%x(V%iLB:V%iUB) ! Rank 1 Array
...
subroutine ADI_VarUnpackContState(V, ValAry, x)
   ...
   associate (DL => V%DL, VarVals => ValAry(V%iLoc(1):V%iLoc(2)))
      ...
      case (ADI_x_AD_rotors_DMST_UA_element_x)
         x%AD%rotors(DL%i1)%DMST%UA%element(DL%i2, DL%i3)%x(V%iLB:V%iUB) = VarVals ! Rank 1 Array
      case (ADI_x_AD_rotors_AA_DummyContState)
...
function ADI_ContinuousStateFieldName(DL) result(Name)
   ...
   case (ADI_x_AD_rotors_DMST_UA_element_x)
       Name = "x%AD%rotors("//trim(Num2LStr(DL%i1))//")%DMST%UA%element("//trim(Num2LStr(DL%i2))//", "//trim(Num2LStr(DL%i3))//")%x"
   case (ADI_x_AD_rotors_AA_DummyContState)
