...
subroutine AD_CopyBldMiscVarType(SrcBldMiscVarTypeData, DstBldMiscVarTypeData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcBldMiscVarTypeData%BN_AxInd)) then
      LB(1:1) = lbound(SrcBldMiscVarTypeData%BN_AxInd, kind=B8Ki)
      UB(1:1) = ubound(SrcBldMiscVarTypeData%BN_AxInd, kind=B8Ki)
   ...
   if (allocated(SrcBldMiscVarTypeData%BN_TanInd)) then
      LB(1:1) = lbound(SrcBldMiscVarTypeData%BN_TanInd, kind=B8Ki)
      UB(1:1) = ubound(SrcBldMiscVarTypeData%BN_TanInd, kind=B8Ki)
   ...
   if (allocated(SrcBldMiscVarTypeData%BN_Vrel)) then
      LB(1:1) = lbound(SrcBldMiscVarTypeData%BN_Vrel, kind=B8Ki)
      UB(1:1) = ubound(SrcBldMiscVarTypeData%BN_Vrel, kind=B8Ki)
   ...
   if (allocated(SrcBldMiscVarTypeData%BN_alpha)) then
      LB(1:1) = lbound(SrcBldMiscVarTypeData%BN_alpha, kind=B8Ki)
      UB(1:1) = ubound(SrcBldMiscVarTypeData%BN_alpha, kind=B8Ki)
   ...
   if (allocated(SrcBldMiscVarTypeData%BN_phi)) then
      LB(1:1) = lbound(SrcBldMiscVarTypeData%BN_phi, kind=B8Ki)
      UB(1:1) = ubound(SrcBldMiscVarTypeData%BN_phi, kind=B8Ki)
   ...
   if (allocated(SrcBldMiscVarTypeData%BN_Re)) then
      LB(1:1) = lbound(SrcBldMiscVarTypeData%BN_Re, kind=B8Ki)
      UB(1:1) = ubound(SrcBldMiscVarTypeData%BN_Re, kind=B8Ki)
   ...
   if (allocated(SrcBldMiscVarTypeData%BN_URelWind_s)) then
      LB(1:2) = lbound(SrcBldMiscVarTypeData%BN_URelWind_s, kind=B8Ki)
      UB(1:2) = ubound(SrcBldMiscVarTypeData%BN_URelWind_s, kind=B8Ki)
   ...
   if (allocated(SrcBldMiscVarTypeData%BN_Cl_Static)) then
      LB(1:1) = lbound(SrcBldMiscVarTypeData%BN_Cl_Static, kind=B8Ki)
      UB(1:1) = ubound(SrcBldMiscVarTypeData%BN_Cl_Static, kind=B8Ki)
   ...
   if (allocated(SrcBldMiscVarTypeData%BN_Cd_Static)) then
      LB(1:1) = lbound(SrcBldMiscVarTypeData%BN_Cd_Static, kind=B8Ki)
      UB(1:1) = ubound(SrcBldMiscVarTypeData%BN_Cd_Static, kind=B8Ki)
   ...
   if (allocated(SrcBldMiscVarTypeData%BN_Cm_Static)) then
      LB(1:1) = lbound(SrcBldMiscVarTypeData%BN_Cm_Static, kind=B8Ki)
      UB(1:1) = ubound(SrcBldMiscVarTypeData%BN_Cm_Static, kind=B8Ki)
   ...
   if (allocated(SrcBldMiscVarTypeData%BN_Cpmin)) then
      LB(1:1) = lbound(SrcBldMiscVarTypeData%BN_Cpmin, kind=B8Ki)
      UB(1:1) = ubound(SrcBldMiscVarTypeData%BN_Cpmin, kind=B8Ki)
   ...
   if (allocated(SrcBldMiscVarTypeData%BN_Cl)) then
      LB(1:1) = lbound(SrcBldMiscVarTypeData%BN_Cl, kind=B8Ki)
      UB(1:1) = ubound(SrcBldMiscVarTypeData%BN_Cl, kind=B8Ki)
   ...
   if (allocated(SrcBldMiscVarTypeData%BN_Cd)) then
      LB(1:1) = lbound(SrcBldMiscVarTypeData%BN_Cd, kind=B8Ki)
      UB(1:1) = ubound(SrcBldMiscVarTypeData%BN_Cd, kind=B8Ki)
   ...
   if (allocated(SrcBldMiscVarTypeData%BN_Cm)) then
      LB(1:1) = lbound(SrcBldMiscVarTypeData%BN_Cm, kind=B8Ki)
      UB(1:1) = ubound(SrcBldMiscVarTypeData%BN_Cm, kind=B8Ki)
   ...
   if (allocated(SrcBldMiscVarTypeData%BN_Cx)) then
      LB(1:1) = lbound(SrcBldMiscVarTypeData%BN_Cx, kind=B8Ki)
      UB(1:1) = ubound(SrcBldMiscVarTypeData%BN_Cx, kind=B8Ki)
   ...
   if (allocated(SrcBldMiscVarTypeData%BN_Cy)) then
      LB(1:1) = lbound(SrcBldMiscVarTypeData%BN_Cy, kind=B8Ki)
      UB(1:1) = ubound(SrcBldMiscVarTypeData%BN_Cy, kind=B8Ki)
...
subroutine AD_CopyRotMiscVarType(SrcRotMiscVarTypeData, DstRotMiscVarTypeData, CtrlCode, ErrStat, ErrMsg)
   ...
   if (allocated(SrcRotMiscVarTypeData%blds)) then
      LB(1:1) = lbound(SrcRotMiscVarTypeData%blds, kind=B8Ki)
      UB(1:1) = ubound(SrcRotMiscVarTypeData%blds, kind=B8Ki)
...
subroutine AD_DestroyRotMiscVarType(RotMiscVarTypeData, ErrStat, ErrMsg)
   ...
   if (allocated(RotMiscVarTypeData%blds)) then
      LB(1:1) = lbound(RotMiscVarTypeData%blds, kind=B8Ki)
      UB(1:1) = ubound(RotMiscVarTypeData%blds, kind=B8Ki)
      do i1 = LB(1), UB(1)
...
subroutine AD_PackRotMiscVarType(RF, Indata)
   ...
   if (allocated(InData%blds)) then
      call RegPackBounds(RF, 1, lbound(InData%blds, kind=B8Ki), ubound(InData%blds, kind=B8Ki))
      LB(1:1) = lbound(InData%blds, kind=B8Ki)
      UB(1:1) = ubound(InData%blds, kind=B8Ki)
      do i1 = LB(1), UB(1)
