    ...
    Int_Xferred = Int_Xferred + 2
      ...
      DO i2 = LBOUND(InData%Vinf,2), UBOUND(InData%Vinf,2)
        DO i1 = LBOUND(InData%Vinf,1), UBOUND(InData%Vinf,1)
          ReKiBuf(Re_Xferred) = InData%Vinf(i1,i2)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
    ...
    END IF
      DO i2 = LBOUND(OutData%Vinf,2), UBOUND(OutData%Vinf,2)
        DO i1 = LBOUND(OutData%Vinf,1), UBOUND(OutData%Vinf,1)
          OutData%Vinf(i1,i2) = ReKiBuf(Re_Xferred)
          Re_Xferred = Re_Xferred + 1
        END DO
      END DO
  END IF
...
IF (ALLOCATED(u_out%Vinf) .AND. ALLOCATED(u1%Vinf)) THEN
  DO i2 = LBOUND(u_out%Vinf,2),UBOUND(u_out%Vinf,2)
    DO i1 = LBOUND(u_out%Vinf,1),UBOUND(u_out%Vinf,1)
      b = -(u1%Vinf(i1,i2) - u2%Vinf(i1,i2))
      u_out%Vinf(i1,i2) = u1%Vinf(i1,i2) + b * ScaleFactor
    END DO
  END DO
...
IF (ALLOCATED(u_out%Vinf) .AND. ALLOCATED(u1%Vinf)) THEN
  DO i2 = LBOUND(u_out%Vinf,2),UBOUND(u_out%Vinf,2)
    DO i1 = LBOUND(u_out%Vinf,1),UBOUND(u_out%Vinf,1)
      b = (t(3)**2*(u1%Vinf(i1,i2) - u2%Vinf(i1,i2)) + t(2)**2*(-u1%Vinf(i1,i2) + u3%Vinf(i1,i2)))* scaleFactor
      c = ( (t(2)-t(3))*u1%Vinf(i1,i2) + t(3)*u2%Vinf(i1,i2) - t(2)*u3%Vinf(i1,i2) ) * scaleFactor
      u_out%Vinf(i1,i2) = u1%Vinf(i1,i2) + b  + c * t_out
    END DO
  END DO
END IF ! check if allocated
IF (ALLOCATED(u_out%pitch) .AND. ALLOCATED(u1%pitch)) THEN
