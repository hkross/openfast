...
class InputWriter_OpenFAST(object):
    ...
    def write_AeroDyn(self):
        ...
        f.write('{:<22d} {:<11} {:}'.format(self.fst_vt['AeroDyn']['Wake_Mod'], 'Wake_Mod', '- Wake/induction model (switch) {0=none, 1=BEMT, 3=OLAF, 4=DMST} [Wake_Mod cannot be 2, 3, or 4 when linearizing]\n'))
        ...
        f.write('======  Blade-Element/Momentum Theory Options  ====================================================== [unused when Wake_Mod=0, 3, or 4, except for BEM_Mod]\n')
        ...
        f.write('{!s:<22} {:<11} {:}'.format(self.fst_vt['AeroDyn']['TipLoss'], 'TipLoss', '- Use the Prandtl tip-loss model? (flag) [unused when Wake_Mod=0, 3, or 4]\n'))
        f.write('{!s:<22} {:<11} {:}'.format(self.fst_vt['AeroDyn']['HubLoss'], 'HubLoss', '- Use the Prandtl hub-loss model? (flag) [unused when Wake_Mod=0, 3, or 4]\n'))
        f.write('{!s:<22} {:<11} {:}'.format(self.fst_vt['AeroDyn']['TanInd'], 'TanInd', '- Include tangential induction in BEMT calculations? (flag) [unused when Wake_Mod=0, 3, or 4]\n'))
        f.write('{!s:<22} {:<11} {:}'.format(self.fst_vt['AeroDyn']['AIDrag'], 'AIDrag', '- Include the drag term in the axial-induction calculation? (flag) [unused when Wake_Mod=0, 3, or 4]\n'))
        f.write('{!s:<22} {:<11} {:}'.format(self.fst_vt['AeroDyn']['TIDrag'], 'TIDrag', '- Include the drag term in the tangential-induction calculation? (flag) [unused when Wake_Mod=0, 3, or 4 or TanInd=FALSE]\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['AeroDyn']['IndToler'], 'IndToler', '- Convergence tolerance for BEMT nonlinear solve residual equation {or "default"} (-) [unused when Wake_Mod=0, 3, or 4]\n'))
        f.write('{:<22d} {:<11} {:}'.format(self.fst_vt['AeroDyn']['MaxIter'], 'MaxIter', '- Maximum number of iteration steps (-) [unused when Wake_Mod=0 or 4]\n'))
        ...
        f.write('======  Double Multiple Streamtube Theory Options  ================================================== [used only when Wake_Mod=4]\n')
        f.write('{:<22d} {:<11} {:}'.format(self.fst_vt['AeroDyn']['DMSTMod'], 'DMSTMod', '- Type of momentum theory model (switch) {1=classic, 2=high load} [used only when Wake_Mod=4]\n'))
        f.write('{:<22d} {:<11} {:}'.format(self.fst_vt['AeroDyn']['Nst'], 'Nst', '- Number of streamtubes [used only when Wake_Mod=4]\n'))
        f.write('{:<22} {:<11} {:}'.format(self.fst_vt['AeroDyn']['DMSTRes'], 'DMSTRes', '- Resolution of induction factor initial guess array [used only when Wake_Mod=4]\n'))
